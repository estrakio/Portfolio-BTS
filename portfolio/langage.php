...
<div class="accordion accordion-flush fond" id="accordionFlushExample">
  <div class="accordion-item fond">
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      ...
      <div class="accordion-body fond_menu coin_rond text-center">
        Le langage HTML (Hypertext Markup Language) est un langage informatique utilisé pour créer des pages web.
        Il utilise une syntaxe composée de balises, qui sont des éléments encadrés par des chevrons,
  ...
  <div class="accordion-item fond">
    ...
    <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <br>
      <div class="accordion-body fond_menu coin_rond text-center">
        PHP est un langage de programmation principalement utilisé pour créer des sites web dynamiques et des applications web.
        Il est open source et gratuit à utiliser.
        <br>
        PHP s'exécute côté serveur.
        Cela signifie que les scripts PHP sont exécutés sur le serveur web avant que la page ne soit envoyée au navigateur de l'utilisateur.
        <br>
  ...
  <div class="accordion-item fond">
    ...
    <div id="flush-collapseQuatre" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <br>
      <div class="accordion-body fond_menu coin_rond text-center">
        ABAP (Advanced Business Application Programming) est un langage de programmation développé par SAP
        pour écrire des applications d'entreprise personnalisées sur leur plateforme logicielle.
        <br>
        ABAP est souvent utilisé pour personnaliser les fonctionnalités de l'application existante.

...
<div class="row text_couleur_bleu">
  ...
  <div class="row padding_content ">
    ...
    <div class=" has-animation animation-ltr text-center">
      <p>
        L'informatique étant en constante évolution, la veille est une partie essentielle de notre travail et peu
    ...
    <div>
      ...
      <div class="row padding_content ">
        <div class="bordure_g_orange has-animation animation-ltr">
          <p>
            ...
            <br>
            Plus simplement, la veille technologique c’est savoir ce tenir au courant des innovations dans notre métier.
          </p>
        </div>
      </div>
      ...
      <div>
        <h2 class="text_couleur_bleu_fonce padding_title">
          <b class="first_letter_orange">C</b>omment je réalise ma veille :
        </h2>
        <div class="row padding_content ">
          <div class="bordure_g_orange has-animation animation-ltr">
            <p>
              ...
              occasionnelement de ce que l'outil me propose.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="text-center">
        <h2 class="text_couleur_bleu_fonce padding_title">
          <b class="first_letter_orange">C</b>ourte vidéo de conseil sur la veille technologique :
        </h2>
        <div class="row  ">
          <div class=" ">
            <iframe class="ombre" width="560" height="315" src="https://www.youtube.com/embed/LCTLGJsbhDg?start=91"
